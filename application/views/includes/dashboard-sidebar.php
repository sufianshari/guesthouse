        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url(); ?>dashboard/reservation/"><i class="fa fa-circle-o"></i> Reservasi Kamar</a></li>
                </ul>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
                <a href="#"><i class="fa fa-th-list"></i> <span>Manajemen Modul</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url(); ?>dashboard/group/"><i class="fa fa-circle-o"></i> Group User</a></li>
                    <li><a href="<?php echo base_url(); ?>dashboard/users/"><i class="fa fa-circle-o"></i> Data User</a></li>
                    <li><a href="<?php echo base_url(); ?>dashboard/hubungi/"><i class="fa fa-circle-o"></i> Kotak Masuk</a></li>
                </ul>
            </li>
