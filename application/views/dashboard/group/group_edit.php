                ...
                <div class="col-md-12">
                    <form action="<?php echo $action; ?>" class="form-horizontal" method="post">
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="group_name"><?php echo lang('edit_group_name_label', 'group_name');?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="group_description"><?php echo lang('edit_group_desc_label', 'description');?></label>
                            <div class="col-sm-9">
